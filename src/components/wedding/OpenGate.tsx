    ...
    >
      ...
      >
        <motion.div
          ...
          className="mb-3"
        >
          <span className="font-serif text-sm md:text-base tracking-[0.25em] text-gold font-medium">
            ॥ श्री गणेशाय नमः ॥
          </span>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-[0.62rem] tracking-[0.35em] text-gold/90 uppercase max-w-xs"
        >
        ...
        <motion.p
          ...
          className="mt-1 text-[0.55rem] tracking-[0.25em] text-parchment/70 uppercase"
        >
          Invite you to the wedding of their granddaughter
        </motion.p>
        ...
        <motion.h2
          ...
          className="mt-7 text-xl font-light text-parchment uppercase sm:text-2xl"
        >
        ...
        <motion.p
          ...
          className="mt-2 text-[0.68rem] tracking-[0.3em] text-gold/90 uppercase"
        >
          Wedding Celebration
        </motion.p>
